  ...
  return (
    <div className="w-full">
      <div className="md:flex flex-col mx-auto w-[85%] pt-20 space-y-16">
        ...
        <div className="md:flex justify-between md:space-x-5 space-y-4">
          ...
          <div className="md:w-[50%] md:flex flex-col justify-between">
            ...
            >
              ...
              <div className="hidden md:flex items-center space-x-2 px-3 py-2 rounded-3xl w-[20%] bg-white bg-opacity-5  border border-white border-opacity-10">
        ...
        <div
          className="md:flex justify-center items-center  md:space-x-10 space-y-4
        "
        >
